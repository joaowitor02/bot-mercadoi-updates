...
_BAIRRO_CIDADE_PB: dict[str, str] = {
    ...
    "industrias": "João Pessoa", "bairro das industrias": "João Pessoa",
    "oitizeiro": "João Pessoa", "alto do mateus": "João Pessoa",
    "alto mateus": "João Pessoa", "colinas do sul": "João Pessoa",
    # Cabedelo
...
class MercadoiDriver:
    ...
    _EXPANDIR_BAIRRO: dict[str, str] = {
        ...
        "industrias":               "Bairro das Indústrias",
        "bairro das industrias":    "Bairro das Indústrias",
        "das industrias":           "Bairro das Indústrias",
        "alto do mateus":           "Alto do Mateus",
        "alto mateus":              "Alto do Mateus",
        "oitizeiro":                "Oitizeiro",
